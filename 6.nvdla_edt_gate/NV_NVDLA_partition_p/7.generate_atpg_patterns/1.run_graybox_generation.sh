...
foreach_in_collection mode_wrapper [get_config_elements Core(NV_NVDLA_partition_p)/Scan/Mode -part tcd -silent] {
  ...
  if {$mode_type eq "external"} {
    ...
    write_core_description ./NV_NVDLA_partition_p_gray_box.tcd -replace
  }
